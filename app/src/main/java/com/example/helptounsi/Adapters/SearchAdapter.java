...
import com.example.helptounsi.Adapters.SearchAdapter.ViewHolder;
...
public class SearchAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        String str = "Nom: " + dataSet.get(position).getName();
        str += "\nVille: " + dataSet.get(position).getCity();
        str += "\nNumero tel: " + dataSet.get(position).getNumber();
